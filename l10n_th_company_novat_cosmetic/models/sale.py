...
class SaleOrder(models.Model):
    _name = "sale.order"
    _inherit = ["sale.order", "base.cosmetic.vat"]
...
class SaleOrderLine(models.Model):
    ...
    _inherit = ["sale.order.line", "base.cosmetic.vat.line"]
    _inverse_field = "order_id"
    _price_field = "price_unit"
    _subtotal_field = "price_subtotal"
    _quantity_field = "product_uom_qty"
    ...
    @api.depends("cosmetic_price_unit", "product_uom_qty")
