...
1.  Go to 'Invoicing \> Configuration \> Payments \> Bank Payment
    Templates'
...
3.  After creating the template, when registering a payment, you will
    see the "Bank Payment Export Template" field. Users can select it,
    and when it comes time to perform the bank payment export, the
    system will automatically populate the values based on the selected
    template.
