...
class TestBankPaymentExportSCB(CommonBankPaymentExport):
    ...
    def setUpClass(cls):
        ...
        cls.bank_export_scb_domestic_format = cls.env.ref(
            "l10n_th_bank_payment_export_scb.scb_domestic"
        )
        cls.bank_export_scb_outward_remittance_format = cls.env.ref(
            "l10n_th_bank_payment_export_scb.scb_outward_remittance"
        )
        ...
        data_dict = [
            ...
            },
            {
                ...
                "value": cls.bank_export_scb_domestic_format.id,
            },
        ]
        ...
        cls.bank_scb = cls.bank_model.create(
            {
                "name": "SCB",
                "bic": "SICOTHBK",
                "bank_code": "014",
        ...
        cls.partner1_bank_scb = cls.create_partner_bank(
            cls, "A001SCB", cls.partner_1, cls.bank_scb
        )
        cls.partner2_bank_scb = cls.create_partner_bank(
            cls, "A002SCB", cls.partner_2, cls.bank_scb
        )

        for line in cls.bank_payment.export_line_ids:
            if line.payment_partner_id == cls.partner_1:
                partner_bank = cls.partner1_bank_scb.id
            else:
                partner_bank = cls.partner2_bank_scb.id
            line.payment_partner_bank_id = partner_bank
    ...
    def test_01_scb_export(self):
        ...
        for line in self.bank_payment.export_line_ids:
            ...
            if line.payment_partner_id == self.partner_2:
                ...
                line.payment_partner_bank_id = self.partner1_bank_scb.id
    ...
    def test_06_scb_outward_remittance(self):
        ...
        self.bank_payment.write(
            {
                "bank_export_format_id": self.bank_export_scb_outward_remittance_format.id,
