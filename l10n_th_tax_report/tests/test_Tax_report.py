...
class TestTax(common.TransactionCase):
    ...
    def _getReportModel(self):
        return self.env["report.tax.report"]

    def _getQwebReportName(self):
        return "l10n_th_tax_report.report_tax_report_pdf"

    def _getXlsxReportName(self):
        return "l10n_th_tax_report.report_tax_report_xlsx"

    def _getXlsxReportActionName(self):
        return "l10n_th_tax_report.action_tax_report_xlsx"
    ...
    def _getBaseFilters(self):
        ...
        self.type = self.env["date.range.type"].create(
            {"name": "Year", "company_id": False, "allow_overlap": False}
        )
...
class TestTaxReport(common.TransactionCase):
    def setUp(self):
        super(TestTaxReport, self).setUp()
    ...
    def test_get_report_html(self):
        report = self.env["report.tax.report"].create(
            {
    ...
    def test_wizard(self):
        wizard = self.env["tax.report.wizard"].create(
            {
                "company_id": self.company_id.id,
                "tax_id": self.tax_id.id,
                "account_id": 1,
