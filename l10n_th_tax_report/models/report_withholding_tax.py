...
class WithHoldingTaxReport(models.TransientModel):
    ...
    def print_report(self, report_type="qweb"):
        ...
        if report_type == "xlsx":
            ...
            report_name = "l10n_th_tax_report.report_withholding_tax_text"
        else:
            report_name = "l10n_th_tax_report.report_withholding_tax_qweb"
    ...
    def _get_html(self):
        ...
        if report:
            ...
            result["html"] = self.env.ref(
                "l10n_th_tax_report.report_withholding_tax_html"
            )._render(rcontext)
        return result
