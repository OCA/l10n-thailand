...
class ResAmphur(models.Model):
    ...
    name = fields.Char(string="Amphur/Khet Name")
    name_eng = fields.Char(string="Amphur/Khet Name English")
    code = fields.Char(string="Code")
    province_id = fields.Many2one("res.province", string="Province")
    tambon_ids = fields.One2many("res.tambon", "amphur_id", string="Tambons/Khwaeng")
