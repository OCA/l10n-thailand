odoo.define("l10n_th_account_tax_report_backend", function (require) {
    "use strict";
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            "click .o_l10n_th_account_tax_report_print": "print",
            "click .o_l10n_th_account_tax_report_export": "export",
        },
    ...
    core.action_registry.add("l10n_th_account_tax_report_backend", report_backend);
