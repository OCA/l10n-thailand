...
class TestIrSequenceBeStandard(SingleTransactionCase):
    ...
    def test_ir_sequence_be_2_check_year(self):
        ...
        self.assertEqual(value, f"test-{year+543-1}/{y_be-1}-0001-{year+543-1}/{y_be-1}")
        value = seq1.next_by_code("test_be")
        self.assertEqual(value, f"test-{year+543-1}/{y_be-1}-0002-{year+543-1}/{y_be-1}")
...
class TestIrSequenceBeDateRange(SingleTransactionCase):
    ...
    def test_ir_sequence_be_date_range_2_check_year(self):
        ...
        self.assertEqual(value, f"test-{year+543-1}/{y_be-1}-0314-{year+543-1}/{y_be-1}")
        value = seq1.next_by_code("test_be_date_range")
        self.assertEqual(value, f"test-{year+543-1}/{y_be-1}-0315-{year+543-1}/{y_be-1}")
